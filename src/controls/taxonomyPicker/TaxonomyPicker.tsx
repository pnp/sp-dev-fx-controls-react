        ...
        <Panel
          ...
          {this.state.loaded === true &&
            ...
            <div key={this.state.termSetAndTerms.Id} >
                ...
                <TermSet autoExpand={null} termset={this.state.termSetAndTerms} activeNodes={this.state.activeNodes} changedCallback={this.termsChanged} multiSelection={this.props.allowMultipleSelections} />
            </div>
