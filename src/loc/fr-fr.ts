...
define([], () => {
  return {
    ...
    CantValidateValidationMessage: "Nous n'avons pas pu vérifier ce lien. Veuillez vérifier le lien et réessayer.",
    ...
    DocumentLabelTemplate: "{0}, Document, Modifié le {1}, édité par {2}, Privé",
    ...
    LinkImageInstructions: "Coller un lien pour une image provenant de OneDrive Entreprise ou SharePoint Online",
    ...
    ListOptionsAlt: "Afficher les options. {0} sélectionné.",
    ListOptionsTitle: "Ouvrez le menu des options d'affichage",
    Loading: "Chargement ...",
    ModifiedByField: "Modifié By",
    ModifiedField: "Date modifié",
    NameField: "Nom",
    No: "Non",
