import { ActionButton, Checkbox, ChoiceGroup, ComboBox, CompoundButton, DatePicker, DefaultButton, IconButton, Link, PrimaryButton, SelectableOptionMenuItemType, SpinButton, Stack, TextField, Toggle } from 'office-ui-fabric-react';
...
export const ControlsTestEnhancedThemeProviderFunctionComponent = () => {
  ...
  return (
    <Stack tokens={{ childrenGap: 10 }}>
      ...
      <CompoundButton theme={theme} secondaryText="This is the secondary text.">CompoundButton</CompoundButton>
      <IconButton iconProps={{ iconName: 'Emoji2' }} title="Emoji" ariaLabel="Emoji" disabled={false} checked={false} />
      <IconButton iconProps={{ iconName: 'Emoji2' }} title="Emoji" ariaLabel="Emoji" disabled={true} checked={false} />
      <IconButton iconProps={{ iconName: 'Emoji2' }} title="Emoji" ariaLabel="Emoji" disabled={true} checked={true} />
      <IconButton iconProps={{ iconName: 'Emoji2' }} title="Emoji" ariaLabel="Emoji" disabled={false} checked={true} />
    </Stack>
  );
};
