...
import { ITag, Stack, Text, TextField } from "office-ui-fabric-react";
import {
  DefaultButton,
  PrimaryButton,
    ...
    return (
      <div className={styles.controlsTest}>
              ...
              actions: [
                {
                  ...
                  applyToTerm: (term: ITerm) =>
                    term && term.Name && term.Name.toLowerCase() === "about us",
                },
            ...
            termActions={{
              actions: [
                ...
                },
                {
                  ...
                  applyToTerm: (term: ITerm) =>
                    term && term.Name && term.Name.toLowerCase() === "secured",
                },
                {
        ...
        <div className={styles.container}>
          <div
            className={`ms-Grid-row ms-bgColor-neutralLight ms-fontColor-neutralDark ${styles.row}`}
          >
            <div className="ms-Grid-col ms-lg10 ms-xl8 ms-xlPush2 ms-lgPush1">
              ...
              <div className="ms-font-m">
                ...
                <ListItemPicker
                  listId={"76a8231b-35b6-4703-b1f4-5d03d3dfb1ca"}
        ...
        <div>
          ...
          {this.state.filePickerResult && (
            <div>
              <div>FileName: {this.state.filePickerResult.fileName}</div>
              <div>File size: {this.state.filePickerResult.fileSize}</div>
            </div>
          )}
        </div>
        ...
        <GridLayout
          ...
          onRenderGridItem={(item: any, finalSize: ISize, isCompact: boolean) =>
