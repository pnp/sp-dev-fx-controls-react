...
import { Progress, IProgressAction } from '../../../Progress';
...
export default class ControlsTest extends React.Component<IControlsTestProps, IControlsTestState> {
  ...
  constructor(props: IControlsTestProps) {
    ...
    this.handleChangeMultiSelectLocked = this.handleChangeMultiSelectLocked.bind(this);
    this.handleChangeMultiSelectList = this.handleChangeMultiSelectList.bind(this);
  }
  ...
  private handleChangeMultiSelect(value: IOnChangeState) {
    this.setState({
      multiSelectSelectedData: value.selectedData
    });
  }

  private handleChangeMultiSelectList(value: IOnChangeState) {
    this.setState({
      multiSelectSelectedDataList: value.selectedData
    });
  }

  private handleChangeMultiSelectLocked(value: IOnChangeState) {
    this.setState({
      multiSelectSelectedDataLocked: value.selectedData
    });
  }
  ...
  public render(): React.ReactElement<IControlsTestProps> {
    ...
    return (
      <div className={styles.controlsTest}>
        ...
        <DateTimePicker
          label="DateTime Picker (unspecified = date and time)"
          timeConvention={TimeConvention.Hours24} value={new Date()}
          onChange={(value) => console.log("DateTimePicker value:", value)}
        />
        ...
        <br />
        <div>
          <Label>MultiSelectLookup with Available Data from state</Label>
          <MultiSelectLookup
          ...
          <br />
          <br />
          <Label>MultiSelectLookup with Available Data from state and with locked items</Label>
          <MultiSelectLookup
            onChanged={this.handleChangeMultiSelectLocked}
            availableData={this.state.multiSelectAvailableData}
            selectedData={this.state.multiSelectSelectedDataLocked}
          />

          <br />
          <br />
          <Label>MultiSelectLookup with Available Data from SharePoint list</Label>
          <MultiSelectLookup
