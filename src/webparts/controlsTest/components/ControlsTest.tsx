  ...
  */
   ...
   */
    ...
    return (<DynamicForm
      ...
      listId={"39f4972e-7a0c-4e36-aec3-191704d0eb5b"}
      onCancelled={() => { console.log('Cancelled'); }}
      onSubmitted={async (listItem) => { let itemdata = await listItem.get(); console.log(itemdata["ID"]); }}
      contentTypeId={'0x010028630460DD4D4741B8EAD968EEA57E1E007C518267F0B14F47882A3401617C6697'}
      webAbsoluteUrl="https://cargillonline.sharepoint.com/sites/TimeKeeper"
    >
