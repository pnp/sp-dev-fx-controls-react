...
import { IOnChangeState, MultiSelectLookup } from '../../../MultiSelectLookup';
...
import { IPickerTerms } from '../../../TaxonomyPicker';
...
export default class ControlsTest extends React.Component<
  ...
  public handleChangeMultiSelect(changeState: IOnChangeState) {
    this.setState({
      multiSelectSelectedData: changeState.selectedData
    });
  }
  ...
  //         moreLink={
  //           <Link href="https://sharepoint.github.io/sp-dev-fx-controls-react/">
  //             See all
  //           </Link>
  //         }
  //       />
  ...
  //       <ListItemAttachments
  //         listId="0ffa51d7-4ad1-4f04-8cfe-98209905d6da"
  //         itemId={1}
