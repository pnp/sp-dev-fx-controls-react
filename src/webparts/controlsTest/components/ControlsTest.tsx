    ...
    return (
      <div className={styles.controlsTest}>
        <div className="ms-font-m">
          ...
          <DynamicForm context={this.props.context} isEditMode={false} listId={"b1416fca-dc77-4198-a082-62a7657dcfa9"} listItemId={1} onCancelled={() => { console.log('Cancelled'); }} onSubmitted={async (listItem) => { let itemdata = await listItem.get(); console.log(itemdata["ID"]); }}></DynamicForm>
        </div>
