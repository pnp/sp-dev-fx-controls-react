...
export class PeoplePickerMockClient {
  public valToCompare: string = "";
  public filterPeople: (value: any, index: number, ar: any[]) => boolean = (value: any, index: number, ar: any[]): boolean => { // eslint-disable-line @typescript-eslint/no-explicit-any
