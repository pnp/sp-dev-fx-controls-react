...
var WorldMap = function (props) {
    ...
    return (React.createElement("section", null,
        React.createElement(MaplibreWorldMap, { theme: props.theme, data: countries, onClick: function (c) { return console.log('Clicked', c); }, title: "Microsoft Locations Worldwide" })));
};
