...
var WorldMap = function (props) {
    var countries = React.useMemo(function () { return [
    ...
    return (React.createElement("section", null,
        React.createElement(MaplibreWorldMap, { theme: props.theme, data: countries, onClick: function (c) { return console.log('Clicked', c); }, mapKey: "fYK99t1qjkKbINH0saMD", title: "Microsoft Locations Worldwide" })));
};
