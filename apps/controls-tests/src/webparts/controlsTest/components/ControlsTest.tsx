...
import {
  ...
  Action,
  HostCapabilities,
} from '@pnp/spfx-controls-react/lib/AdaptiveCardHost';
import {
...
> {
  ...
  private _onIconSizeChange(element?: IDropdownOption): void {
    this.setState({
      imgSize: parseInt((element?.key || 0).toString()),
    });
  }
  ...
  public render(): React.ReactElement<IControlsTestProps> {
    ...
    let dynamicFormListItemId: number = 0;
                ...
                actions: [
                  {
                    ...
                    actionCallback: async (
                      ...
                      const updateAction: UpdateAction = {
                        updateActionType: UpdateType.updateTermLabel,
                        value: `${currentTerm.Name} (updated)`,
                      };
                      return updateAction;
                    },
                ...
                actions: [
                  ...
                  },
                  {
                    ...
                    actionCallback: async (
                      ...
                      if (term.TermsCount && term.TermsCount > 0) {
                        return {
                          updateActionType: UpdateType.disableTerm,
                          value: true,
                        };
