...
import TestForm, { ITestFormProps } from './components/TestForm';
...
const LOG_SOURCE: string = 'TestFormCustomizer';

export default class TestFormCustomizer
  extends BaseFormCustomizer<ITestFormCustomizerProperties> {
